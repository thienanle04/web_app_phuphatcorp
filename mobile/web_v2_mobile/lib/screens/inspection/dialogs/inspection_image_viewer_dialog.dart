...
class InspectionImageViewerDialog extends StatefulWidget {
  final List<InspectionImage> images;
  final int initialIndex;

  const InspectionImageViewerDialog({
    super.key,
  ...
  @override
  State<InspectionImageViewerDialog> createState() => _InspectionImageViewerDialogState();
}

class _InspectionImageViewerDialogState extends State<InspectionImageViewerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl = ApiEndpoints.vehicleInspectionFile(currentImg.filename);
