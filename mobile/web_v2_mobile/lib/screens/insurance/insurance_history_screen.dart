...
class _InsuranceHistoryScreenState extends State<InsuranceHistoryScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<InsuranceProvider>().fetchVehicleHistory(widget.vehicleId);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Lịch sử BH xe ${widget.plateNumber}',
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              'Chưa có lịch sử bảo hiểm cho xe này.',
                              style: TextStyle(
                                fontSize: 14,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Ngày mua: ${FormatUtils.formatDate(item.purchaseDate)}',
                                            style: TextStyle(
                                              fontSize: 13,
