...
class _InsuranceListScreenState extends State<InsuranceListScreen> {
  ...
  final List<Map<String, String>> _statusFilters = [
    ...
    {'value': 'chua_co_bao_hiem', 'label': 'Chưa có BH'},
  ];
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<InsuranceProvider>().fetchSummary();
      }
    });
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: canManage
          ? FloatingActionButton.extended(
              ...
              label: const Text('Thêm bảo hiểm', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            )
          : null,
      body: SafeArea(
        child: Column(
                          ...
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 12),
                                  Text(
                                    'Không tìm thấy dữ liệu bảo hiểm nào.',
                                    style: TextStyle(
                                      fontSize: 14,
                          ...
                          : RefreshIndicator(
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final hasInsurance = vehicle.latestInsuranceId != null;
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (_) => InsuranceDetailScreen(
                                              insuranceId: vehicle.latestInsuranceId!,
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  '${vehicle.insuranceCount} lần mua BH',
                                                  style: TextStyle(
                                                    fontSize: 11,
                                                    fontWeight: FontWeight.w500,
                                                    color: isDark ? AppColors.neutral400 : AppColors.neutral600,
                                              ...
                                              Expanded(
                                                child: Row(
                                                  children: [
                                                    ...
                                                    const SizedBox(width: 6),
                                                    Text(
                                                      'Mua: ${FormatUtils.formatDate(vehicle.latestPurchaseDate)}',
                                                      style: TextStyle(
                                                        fontSize: 12,
                                                        color: isDark ? AppColors.neutral400 : AppColors.neutral600,
                                                      ),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  Text(
                                                    hasInsurance ? 'Chi tiết' : (canManage ? 'Thêm mới' : 'Chưa có BH'),
                                                    style: TextStyle(
                                                      fontSize: 12,
