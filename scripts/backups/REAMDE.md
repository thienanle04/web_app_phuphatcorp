...
backup:
pg_dump --dbname="postgresql://phuphat:phuphat_dev@localhost:5433/phuphatcorp_dev" -Fc --no-owner --no-acl -t route_pricing_adjustment_periods -t delivery_routes -t route_groups -t route_group_members -t route_price_configs -t route_price_versions -t route_price_tiers -f scripts/backups/route-pricing.dump
